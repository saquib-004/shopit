...
// this route is only to create an order for COD
...
async function getSalesData(startDate, endDate) {
    ...
    // Create a Map to store sales data and number of orders by data.
...
export const getSales = catchAsyncErrors(async (req, res, next) => {
    ...
    // set the start hour of day to startDate in hours, min, sec, millisec
    startDate.setUTCHours(0, 0, 0, 0);
    // set the end hour of day to endDate in hours, min, sec, millisec
