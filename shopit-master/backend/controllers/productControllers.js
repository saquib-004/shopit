...
export const uploadProductImages = catchAsyncErrors(async (req, res) => {
    ...
    const urls = await Promise.all((req?.body?.images).map(uploader)).then(console.log("Image uploaded")).catch(console.error);
...
export const createProductReview = catchAsyncErrors(async (req, res, next) => {
    ...
    // if user has given the review then update the review otherwise give a new review
