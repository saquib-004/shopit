...
import { useOrderDeatailsQuery, useUpdateOrderMutation } from '../../redux/api/orderApi';
...
const ProcessOrder = () => {
    ...
    const { data } = useOrderDeatailsQuery(params?.id);
  ...
  return (
    <AdminLayout className="row d-flex justify-content-around">
