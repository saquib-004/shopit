...
const UploadImages = () => {
  ...
  return (
    <AdminLayout className="row wrapper">
      ...
      <div className="col-10 col-lg-8 mt-5 mt-lg-0">
        <form className="shadow rounded bg-body" enctype="multipart/form-data" onSubmit={submitHandler}>
          ...
          <button id="register_button" type="submit" className="btn fetch-btn w-100 py-2" disabled={isLoading || isDeleteLoading}>
