        ...
        {cartItems?.map((item) => (
            ...
            <div className="row">
                ...
                <div className="stockCounter d-inline">
                    <span className="btn btn-danger minus" onClick={(e) => decreaseQty(item, item?.quantity)}> - </span>
                    <input
                    type="number"
                    ...
                    readonly
                    />
                    <span className="btn btn-primary plus" onClick={(e) => increaseQty(item, item?.quantity)}> + </span>
                </div>
                </div>
